...
public class FormasGeometricas {
	...
	*/
	...
	public static void armazenar(FormasGeometricas fg) {
		triangulos.add(fg);
	}
    public static void calculaAreaTriangulo(double base,double altura,FormasGeometricas fg) {
